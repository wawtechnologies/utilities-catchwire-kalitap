...
static struct usb_device_id rtw_usb_id_tbl[] ={
	...
	{USB_DEVICE(0x7392, 0xA811),.driver_info = RTL8821},
        /* Edimax - EW-7811USC, EW-7811UTC, EW-7811UAC */

	{USB_DEVICE(0x7392, 0xA812),.driver_info = RTL8821},
        /* Edimax - EW-7811UTC 7392 A812 */

	{USB_DEVICE(0x04BB, 0x0953),.driver_info = RTL8821},
   	/* I-O DATA - Edimax */

	{USB_DEVICE(0x2001, 0x3314),.driver_info = RTL8821},
	/* D-Link - DWA-171 rev A1 */

	{USB_DEVICE(0x2001, 0x3318),.driver_info = RTL8821},
	/* D-Link - DWA-172 rev A1  */

	{USB_DEVICE(0x0E66, 0x0023),.driver_info = RTL8821},
	/* HAWKING HD65U - Edimax */

	{USB_DEVICE(0x0846, 0x9052),.driver_info = RTL8821},
	/* Netgear - A6100 */

	{USB_DEVICE(0x0BDA, 0xA811),.driver_info = RTL8821},
	/* GTEN G5W150, Manhattan 525602 - Edimax */

	{USB_DEVICE(0x0411, 0x0242),.driver_info = RTL8821},
	/* Buffalo WI-U2-433DM - Delta Networks */

	{USB_DEVICE(0x20F4, 0x804B),.driver_info = RTL8821},
	/* TRENDNet TEW-804UB */	
#endif
