...
/*
 * cpswsl1set.c - CPSW SL1 Registers Set Utility
 *
 * Usage : cpswsl1set <register> <value>
...
main(int argc, char *argv[])
{
  ...
  {
    {"maccontrol", required_argument, 0, SL1_MACCONTROL},
    {"soft_reset", required_argument, 0, SL1_SOFT_RESET},
    {"rx_maxlen" , required_argument, 0, SL1_RX_MAXLEN },
    {"bofftest"  , required_argument, 0, SL1_BOFFTEST  },
    {"emcontrol" , required_argument, 0, SL1_EMCONTROL },
    {"rx_pri_map", required_argument, 0, SL1_RX_PRI_MAP},
    {"tx_gap"    , required_argument, 0, SL1_TX_GAP    },
    {0           , 0                , 0, 0             }
  };
