...
/*
 * cpswsl1get.c - CPSW SL1 Registers Get Utility
 *
 * Usage : cpswsl1get <register>
...
main(int argc, char *argv[])
{
  ...
  {
    {"idver"     , no_argument, 0, SL1_IDVER     },
    {"maccontrol", no_argument, 0, SL1_MACCONTROL},
    {"macstatus" , no_argument, 0, SL1_MACSTATUS },
    {"soft_reset", no_argument, 0, SL1_SOFT_RESET},
    {"rx_maxlen" , no_argument, 0, SL1_RX_MAXLEN },
    {"bofftest"  , no_argument, 0, SL1_BOFFTEST  },
    {"rx_pause"  , no_argument, 0, SL1_RX_PAUSE  },
    {"tx_pause"  , no_argument, 0, SL1_TX_PAUSE  },
    {"emcontrol" , no_argument, 0, SL1_EMCONTROL },
    {"rx_pri_map", no_argument, 0, SL1_RX_PRI_MAP},
    {"tx_gap"    , no_argument, 0, SL1_TX_GAP    },
